...
export const messages: Messages = {
  ...
  home: {
    title: "Nar Transfer — transferir archivos con luz",
    metaDescription:
    ...
    shareSite: "Compartir Nar Transfer",
    supportTitle: "Gratis, de código abierto, sin anuncios",
    supportBodyHtml:
      'Si Nar Transfer le facilitó el día, puede <a href="https://buymeacoffee.com/bashalarmist" target="_blank" rel="noopener noreferrer">invitarme un café</a>.',
  ...
  receive: {
    ...
    clearCache: "Borrar caché de Nar Transfer",
  ...
  verdicts: {
    olderSender: (version) =>
      `Esa pantalla está enviando un formato Nar Transfer más antiguo (v${version}). Actualice el dispositivo emisor.`,
    newerSender: (version) =>
      `Esa pantalla está enviando un formato Nar Transfer más nuevo (v${version}). Actualice esta aplicación para recibirlo.`,
    unsupportedFlags:
      "Esa transmisión usa una función de Nar Transfer que esta versión no puede leer. Actualice esta aplicación para recibirla.",
  },
  ...
  i18n: {
    ...
    switchOffer: "Nar Transfer está disponible en español.",
