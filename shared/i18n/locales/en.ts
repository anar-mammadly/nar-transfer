...
export const messages: Messages = {
  ...
  home: {
    title: "Nar Transfer — transfer files with light",
    metaDescription:
    ...
    shareSite: "Share Nar Transfer",
    supportTitle: "Free, open source, no ads",
    supportBodyHtml:
      'If Nar Transfer made your day easier, you can <a href="https://buymeacoffee.com/bashalarmist" target="_blank" rel="noopener noreferrer">buy me a coffee</a>.',
  ...
  send: {
    ...
    shareTitleData: "Nar Transfer — receiver",
  ...
  receive: {
    ...
    clearCache: "Clear Nar Transfer cache",
  ...
  verdicts: {
    olderSender: (version) =>
      `That screen is sending an older Nar Transfer format (v${version}). Update the sending device.`,
    newerSender: (version) =>
      `That screen is sending a newer Nar Transfer format (v${version}). Update this app to receive it.`,
    unsupportedFlags:
      "That stream uses a Nar Transfer feature this version cannot read. Update this app to receive it.",
  },
  ...
  i18n: {
    ...
    switchOffer: "Nar Transfer is available in English.",
